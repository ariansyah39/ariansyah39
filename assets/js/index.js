        ...
        let testimonialsLists = [
            {
                ...
                nama : 'Elmano' ,
                status : 'ProGamer' ,
                testimoni : 'ApeenKun Store memberikan layanan yang cepat dan efisien. Saya sangat puas dengan pengalaman belanja online di sini!' ,
            }, 
            {
                id : 2, 
                nama : 'Jaylen' ,
                status : 'ProGramer' ,
                testimoni : 'Belanja di ApeenKun Store sangat praktis dan terjamin keamanannya.' ,
            },
            {
                id : 3, 
                nama : 'Alexander' ,
                status : 'Programmer' ,
                testimoni : 'Saya selalu mendapatkan voucher game dengan harga terbaik di ApeenKun Store.' ,
            },
            {
                id : 4, 
                nama : 'Apollo' ,
                status : 'Programmer' ,
                testimoni : 'Mantap top up di ApeenKun Store sangat amanah.' ,
            },
